...
<body <?php body_class(); ?>>
  <header class="site-header">
    <div class="container">
      <h1 class="logo-text float-left"><a href="<?php echo site_url() ?>">Some <strong>Hospital</strong></a></h1>
      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          <ul>
            ...
            <li <?php if (get_post_type() == 'specialty') echo 'class="current-menu-item"' ?>><a href="<?php echo get_post_type_archive_link('specialty') ?>">Specialties</a></li>
